...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/29 15:06:01 by rbalbous          #+#    #+#             */
/*   Updated: 2018/06/28 14:14:39 by afoures          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "corewar.h"

int			get_all_arg_ldi(int *pc, t_lstprocess *process, int decal)
{
	int		arg;
	int		value;
...
int			inst_ldi(int pc, t_lstprocess *process)
{
	...
	adress = get_all_arg_ldi(&pc, process, 6);
	reg = 3;
	...
	adress = (process->pc + adress % IDX_MOD) % MEM_SIZE;
